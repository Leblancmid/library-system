...
@section('content')
    ...
    {{-- Open modal if there were validation errors (form was submitted) --}}
    @if ($errors->any())
        <script>document.addEventListener('DOMContentLoaded', () => document.getElementById('addModal').classList.add('open'));</script>
    @endif

    {{-- ===== ADD BOOK MODAL ===== --}}
    <div class="modal-backdrop" id="addModal" role="dialog" aria-modal="true" aria-labelledby="modalTitle">
        <div class="modal">
            <div class="modal-head">
                <div>
                    <h2 class="modal-title" id="modalTitle">Add Book</h2>
                    <p class="modal-subtitle">Create a new book record.</p>
                </div>
            ...
            <form method="GET" action="{{ route('books.index') }}">
                <div class="toolbar-grid">
                    <div class="field">
                        ...
                        <input id="q" name="q" value="{{ request('q') }}" placeholder="Search title, author, or ISBN…" />
                    </div>
                        ...
                        <tr>
                            <td>
                                <div class="title-cell">
                                    ...
                                    <span class="meta"><span>ID: {{ $b->id }}</span></span>
                                </div>
                            </td>
                            <td>{{ $b->author ?? '—' }}</td>
                            <td>{{ $b->isbn ?? '—' }}</td>
                        ...
                        <tr>
                            <td colspan="7">
                                <div class="empty">
                                    ...
                                    <p>Try changing your search or <button class="btn btn-ghost btn-small"
                                            onclick="openModal()">add your first book</button>.</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
